...
def get_args():
    ...
    parser.add_argument('--use_defense', action='store_true',
                        help='Enable defense mechanisms against attacks')
    parser.add_argument('--defense_sanitize', action='store_true',
                        help='Sanitize data to remove potential poisoned samples')
    parser.add_argument('--defense_validate', action='store_true',
                        help='Validate checkpoint integrity')
    parser.add_argument('--defense_backup', action='store_true',
                        help='Create backups of model checkpoints')
    parser.add_argument('--defense_mitigate', action='store_true',
                        help='Apply BrainWash mitigation')
